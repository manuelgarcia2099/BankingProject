...
(function( $ ){
	...
	$.fn.multiDatesPicker = function(method) {
       //   var indice = formulario.anios.selectedIndex;
			...
			init : function( options ) {
				...
				var mdp_events = {
					...
					onSelect : function(dateText, inst) {
						...
						var elementos = dateText.split('-');
						var fecha = elementos[1] + "-" + elementos[2] + "-" + elementos[0];
						var ahora = new Date();
					    var seleccionado= new Date(fecha);
//					    var seleccionado= new Date(elementos[0],elementos[1],elementos[2]);
						
                       if(seleccionado<ahora){
//                    	   alert("La fecha debe ser mayor al dia de hoy ["+fecha+"]: "  + seleccionado + "\n" + ahora); 
